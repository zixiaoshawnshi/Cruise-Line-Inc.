...
{
    // [CustomEditor(typeof(BuildableObjectEffects))]
    // public class BuildableObjectEffectsEditor : Editor
    // {
    ...
    //             string uxmlPath = System.IO.Path.Combine(scriptDirectory, "BuildableObjectEffectsEditor.uxml");
    //             visualTreeAsset = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>(uxmlPath);
    //         }
    //         visualTreeAsset.CloneTree(root);

    //         MonoScript script = MonoScript.FromMonoBehaviour((BuildableObjectEffects)target);
