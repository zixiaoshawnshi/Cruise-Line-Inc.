...
{
    [CustomEditor(typeof(BuildableGridObjectSO))]
    public class BuildableGridObjectSOEditor : Editor
    {
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            if (visualTreeAsset == null)
            {
                ...
                string uxmlPath = System.IO.Path.Combine(scriptDirectory, "BuildableGridObjectSOEditor.uxml");
