...
{
    [ExecuteInEditMode]
    public class EditorGridVisualHandlerXZ : MonoBehaviour
    {
        #if UNITY_EDITOR
        ...
        private void UpdateColliderProperties(int gridIndex)
        {
            ...
            float offsetZ = (cellSize * gridLength / 2) + gridOriginList[gridIndex].z;  

            gridCollider.center = new Vector3(offsetX - transform.position.x, gridOriginList[gridIndex].y - transform.position.y, offsetZ - transform.position.z);
        ...
        private void UpdateEditorCanvasGridProperties(int thisGridVerticalIndex)
        {
            ...
            editorCanvasGridsList[thisGridVerticalIndex].eulerAngles = new Vector3(90, 0, 0);
        ...
        private void UpdateEditorObjectGridVisuals(EasyGridBuilderPro.ObjectGridSettings objectGridSettings, int thisGridVerticalIndex, GridMode activeGridMode)
        {
            ...
            editorObjectGridsList[thisGridVerticalIndex].position = gridOriginList[thisGridVerticalIndex] + (new Vector3(gridWidth * cellSize, 0, gridLength * cellSize) / 2);
