...
{
    [CustomEditor(typeof(EasyGridBuilderProXY))]
    public class EasyGridBuilderProXYEditor : Editor
    {
        public VisualTreeAsset visualTreeAsset;
        private VisualElement root;
        
        private EasyGridBuilderProXY easyGridBuilderProXY;
        ...
        {
            easyGridBuilderProXY = (EasyGridBuilderProXY)target;
        }
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            if (visualTreeAsset == null)
            {
                ...
                string uxmlPath = System.IO.Path.Combine(scriptDirectory, "EasyGridBuilderProXYEditor.uxml");
                visualTreeAsset = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>(uxmlPath);
            }
            visualTreeAsset.CloneTree(root);

            MonoScript script = MonoScript.FromMonoBehaviour((EasyGridBuilderProXY)target);
        ...
        {
            easyGridBuilderProXY.GenerateGridUniqueID(true);
            SetComponentDirty();
        }
        ...
        {
            easyGridBuilderProXY.GenerateRandomSeed();
        }

        private void SetComponentDirty()
        {
            Undo.RecordObject(easyGridBuilderProXY, "Modified MyComponent");
            EditorUtility.SetDirty(easyGridBuilderProXY);
